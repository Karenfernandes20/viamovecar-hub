      ...
      <section className="grid gap-4 md:grid-cols-4">
        <Card className="elevated-card animate-card-fade-up border-none bg-card/90">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">Passageiros cadastrados</CardTitle>
            <Users className="h-4 w-4 text-primary" />
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-semibold">18.245</p>
            <p className="mt-1 text-[11px] text-muted-foreground">Base consolidada em todas as cidades ativas.</p>
          </CardContent>
        </Card>

        <Card className="elevated-card animate-card-fade-up border-none bg-card/90">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">Motoristas cadastrados</CardTitle>
            <Users className="h-4 w-4 text-primary" />
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-semibold">4.392</p>
        ...
        <Card className="elevated-card animate-card-fade-up border-none bg-card/90">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">Corridas em andamento</CardTitle>
        ...
        <Card className="elevated-card animate-card-fade-up border-none bg-card/90">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">Cidades ativas</CardTitle>
        ...
        <Card className="elevated-card border-none bg-card/95">
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Distribuição das corridas concluídas nos últimos 30 dias.</p>
            </div>
          </CardHeader>
          <CardContent className="pt-0">
            <ChartContainer config={chartConfig} className="mt-2 h-64">
